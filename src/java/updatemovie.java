...
public class updatemovie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        pst = con.prepareStatement("update movies set name=?,release_date=?,actor=?,actress=? where movie_id=?");
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<p>The Above Details has been updated to the Database</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
